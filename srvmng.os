...
Функция main()
	Перем чРезультат, бТолькоОстановить;
	Перем б1СРаботает, бPGРаботает, сПароль, мАргументы, чЭлемент;
	Перем ОК, НЕОК;
	...
	// -a <action> : (--action) действие (start, stop, restart), которое должен сделать скрипт. 
